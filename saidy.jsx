  ...
  return (
    <div className="min-h-screen app-bg text-[color:var(--ink)] font-sans">
      ...
      <div className="md:flex">
        {/* Seitenleiste */}
        <aside className="hidden md:w-56 md:fixed md:inset-y-0 md:flex md:flex-col md:border-r border-stone-200 bg-white">
          <div className="px-5 py-4 border-b border-stone-100">
            <div className="text-lg font-semibold tracking-tight akzent-text">Saidy</div>
            <div className="text-xs text-stone-400">{saveState === "saving" ? "Speichert …" : "Gespeichert"}</div>
          </div>
          <nav className="hidden md:flex md:flex-col gap-1 px-2 py-2 md:py-3">
            {tabs.map((t) => {
              const Icon = t.icon;
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm font-medium whitespace-nowrap transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-stone-500 ${
                    active ? "akzent-ton" : "text-stone-500 hover:bg-stone-50 hover:text-stone-800"
                  }`}
                >
          ...
          <div className="hidden md:block mt-auto px-5 py-4 border-t border-stone-100">
            <button
              onClick={() => setShowSettings(true)}
              className="w-full flex items-center gap-2 text-xs text-stone-400 hover:text-stone-700"
            >
